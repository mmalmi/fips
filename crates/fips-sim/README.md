...
after successful probes or degradation, integer trust scores, newcomer probe
slots, and final admission ordering. Historic lookup is represented as a normal
Nostr filter over signed rating facts, including kind `7368` and
`#i=["fips.peer"]`, matching the hashtree stored-index query surface.
