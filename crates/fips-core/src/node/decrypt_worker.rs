...
//!
//! Worker messages travel through three bounded per-worker lanes:
//!
...
//!   releases the owned cipher + replay state. It uses the control
//!   lane.
//!
...
//! are grouped by the peer/session owner, and FSP AEAD open/replay/retirement
//! stays inside the source-peer ordered owner before TUN/endpoint delivery.
