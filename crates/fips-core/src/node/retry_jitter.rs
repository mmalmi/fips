...
// Keep consecutive-outage recovery comfortably inside the 20s production
// deadline while the per-tick peer budget below prevents a probe storm.
const ACTIVE_DIRECT_REFRESH_RETRY_DELAY_MS: u64 = 1_000;
const ACTIVE_DIRECT_REFRESH_RETRY_JITTER_MS: u64 = 1_000;
