    ...
    #[test]
    fn fsp_open_worker_selection_spreads_ticket_sequence_across_siblings() {
        let (pool, _control, _priority, _bulk, _fsp_completion) =
            test_worker_pool_with_fsp_completion_receivers(4, 4);
        ...
        for owner_idx in 0..4 {
            ...
            for sequence in 0..12 {
                let open_idx = pool
                    .worker_idx_for_fsp_open_avoiding(&source_addr, owner_idx, sequence)
            ...
            assert_eq!(
                ...
                3,
                "ticket sequence should spread opener work across all siblings"
            );
        }
    }
