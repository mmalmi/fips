...
impl Node {
    ...
    pub fn new(config: Config) -> Result<Self, NodeError> {
        ...
        Ok(Self {
            ...
            deferred_dataplane_control_turns: VecDeque::new(),
            deferred_session_forwards: Default::default(),
            dataplane_fast_ingress_rx: None,
            dataplane_direct_fsp_sources: Arc::new(HashMap::new()),
            dataplane_direct_fsp_sources_dirty: true,
