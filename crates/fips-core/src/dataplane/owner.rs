...
pub(crate) struct OwnerReservation {
    ...
    path_mtu: u16,
    wire_flags: u8,
    receive_epoch: Option<(DataplaneReceiveEpoch, u64)>,
    source_peer: Option<crate::PeerIdentity>,
...
pub(crate) struct OwnerState {
    ...
    pending_fmp_authenticated_k_bit: Option<bool>,
    ...
    pending_receive_epoch_instance: u64,
    pending_replay_counters: std::collections::HashSet<((DataplaneReceiveEpoch, u64), u64)>,
