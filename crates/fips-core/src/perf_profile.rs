...
pub enum Event {
    ...
    DataplaneAeadResultDeposits = 245,
    DataplaneAeadResultDepositPackets = 246,
...
impl Event {
    const fn name(self) -> &'static str {
        match self {
            ...
            Event::DataplaneAeadResultDeposits => "dataplane_aead_result_deposits",
            Event::DataplaneAeadResultDepositPackets => "dataplane_aead_result_deposit_packets",
...
fn event_from_index(idx: usize) -> Event {
    match idx {
        ...
        245 => Event::DataplaneAeadResultDeposits,
        246 => Event::DataplaneAeadResultDepositPackets,
...
#[inline]
pub(crate) fn record_dataplane_aead_result_deposit(packets: usize) {
    if !enabled() || packets == 0 {
        return;
    }
    record_event_count_sample(Event::DataplaneAeadResultDeposits, 1);
    record_event_count_sample(Event::DataplaneAeadResultDepositPackets, packets as u64);
}
